                        ...
                        <ul>
                            <#list document.threatAffects as item>
                                <li>
                                    ...
                                    <#if item.versionsAffetcted??>
                                        Versions:
                                        <#list item.versionsAffetcted as version>
                                            ${version}<#sep>,
                                        </#list>
                                    </#if>
                    ...
                    <div class="article-header">
                        ...
                        <ul>
                            <#list document.cveIdentifiers as item>
                                <li>
                                    ${item.cveIdentifier}
                                    <@hst.html hippohtml=item.cveText contentRewriter=gaContentRewriter/>
                                </li>
                            </#list>
                        </ul>
                    </div>
                    ...
                    <div class="article-header">
                        ...
                        <ul>
                            <#list document.cyberAcknowledgements as item>
                                <li>
                                    ${item.linkAddress}
                                    <@fmt.formatDate value=item.responseDatetime.time?date type="date" pattern="d MMM yyyy HH:mm:ss" timeZone="${getTimeZone()}" />
                                </li>
                            </#list>
                        </ul>
                    </div>
